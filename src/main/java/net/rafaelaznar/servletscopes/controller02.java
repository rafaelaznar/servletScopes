...
import static net.rafaelaznar.servletscopes.controller01.log;
import org.apache.log4j.Logger;

/**
 * Servlet controller02
 *
 * @author rafael aznar
 */
public class controller02 extends HttpServlet {
    ...
    static Logger log = Logger.getLogger(controller02.class);
    /**
     * Inicialiación
     *
     * @param oConfig
    ...
    public void init(ServletConfig oConfig) throws ServletException {
        ...
        log.info("inicializando servlet controller02");
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        log.info("petición al controller02");
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet controller02</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            out.println("<h1>Servlet Controller02</h1><hr/>");

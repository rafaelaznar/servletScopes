...
/**
 * Servlet controller05: Para resetear la sesión.
 *
 * @author rafael aznar
 */
public class controller05 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {            
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>servlet controller05</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Controller05</h1><hr/>");
            HttpSession oSession = request.getSession();
            oSession.invalidate();
            out.println("<h3>Se ha cerrado la sesión.</h3>");

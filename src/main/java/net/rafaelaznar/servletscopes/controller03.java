...
public class controller03 extends HttpServlet {
    ...
    public void init(ServletConfig oConfig) throws ServletException {
        ...
        log.info("inicializando servlet controller03");
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        log.info("petición al controller03");
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet controller03</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            out.println("<h1>Servlet Controller03</h1><hr/>");
